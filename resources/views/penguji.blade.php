                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <form id="haps-form536174848595959" action="{{ url('/penguji/hapus') }}" method="POST" style="display: none;">
                          {{ csrf_field() }}
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="#hap" onclick="event.preventDefault(); document.getElementById('haps-form53617486775759').submit();"><span class='fa fa-trash' title="hapus data" style="color:red"></span></a>
                      <form id="haps-form53617486775759" action="{{ url('/penguji/hapus') }}" method="POST" style="display: none;">
                          {{ csrf_field() }}
                          <input class="form-control" name="pendidhap" type="text" value="53617486775759">
                          <!-- <input class="form-control" name="temp" type="text" value="1"> -->
                      </form>
                    </td>
                  </tr>
