...
<div class="register-box" style="width: 800px">
  <div class="register-logo">
    <a href="statusLolosBerkas">Halaman Cek Status Peserta<br/><b>SILKMMTL</b></a>
  </div>
  ...
  <div class="register-box-body">
    ...
    <div class="social-auth-links text-center">
    	<button class="btn btn-primary btn-block btn-flat" onclick="statusLolosBerkas();">Cek Status</button>
    </div>
