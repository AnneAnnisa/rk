...
<div class="register-box" style="width: 800px">
  <div class="register-logo">
    <a href="statusGagalBerkas">Halaman Cek Status Peserta<br/><b>SILKMMTL</b></a>
  </div>
  ...
  <div class="register-box-body">
    ...
    <div class="social-auth-links text-center">
    	<button class="btn btn-primary btn-block btn-flat" onclick="statusGagalBerkas();">Cek Status</button>
    </div>
