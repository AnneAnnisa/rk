            ...
            @endif
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr data-divisi="1">
                    ...
                    <td>
                      <a href="{{ url('/seleksi/lolos') }}" ><span class="glyphicon glyphicon-ok" style="color:green" title="lolos"></span></a>

                      <a href="{{ url('/seleksi/gagal') }}" ><span class="glyphicon glyphicon-remove" style="color:red" title="gagal"></span></a>

                      <a href="#pendf" class="hehe" id="hehe1" data-temp="1"  data-toggle="modal" data-target="#nilai1"\><span class='fa fa-file' title="lihat data" style="color:navy"></span></a>
                  ...
                  <tr data-divisi="2">
                    ...
                    <td>
                      ...
                      <a href="{{ url('/seleksi/hapus') }}"><span class='fa fa-trash' title="hapus data" style="color:red"></span></a>
                    </td>
